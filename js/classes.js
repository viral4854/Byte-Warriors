...
class Fighter extends Sprit{
    ...
    switchSprite(sprite){
        ...
        //over ridding death , once dead nothing else is allowed 
        ...
        // overridding all other animations witht the attack animation
        if(this.image === this.sprites.attack1.image && 
        this.framesCurrent < this.sprites.attack1.framesMax - 1) 
            return

        // overridding all other animation with take hit animation
